        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Thay đổi thông tin đăng nhập</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-dark btn-flat"><div class="fa fa-angle-left"></div> Trở về danh sách đặt hàng</a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group d-flex justify-content-end">
                                <button class="btn btn-dark btn-flat">Thay đổi</button>
                            </div>
                        </form>
                    </div>
            </div>
